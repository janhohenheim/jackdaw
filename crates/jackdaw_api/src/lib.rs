...
pub use jackdaw_api_internal::{
    ...
    JackdawExtension, MenuEntryDescriptor, PanelContext, ToAnchorId as _, WindowDescriptor,
};
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        InspectorWindow, JackdawExtension, MenuEntryDescriptor, PanelContext, WindowDescriptor,
        operator,
    };
